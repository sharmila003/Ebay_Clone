  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="flex justify-between items-center p-4 bg-white shadow">
        <img src={download} alt="Company Logo" className="w-25 h-12" />
        <div>
      ...
      <div className="flex flex-grow">
        <div className="flex flex-col items-center justify-center w-1/2 bg-gray-100 p-4">
          {selectedOption === 'personal' ? (
            <img src={personalImage} alt="Personal" className="w-full h-auto mb-4" />
          ) : (
            <img src={businessImage} alt="Business" className="w-full h-auto mb-4" />
          )}
        </div>
