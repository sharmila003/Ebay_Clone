        ...
        <Carousel.Item>
          <div className="relative">
            <div className="absolute bottom-16 left-0 w-full md:w-[25%] text-center md:text-left md:left-[10%]">
              ...
              <div className="text-lg border-[1px] border-white rounded-full py-2 px-3 inline-block w-[40%]">
                Shop now
              </div>
            </div>
            <img
        ...
        <Carousel.Item>
          <div className="relative">
            <div className="absolute bottom-16 left-0 w-full md:w-[25%] text-center md:text-left md:left-[10%]">
              ...
              <div className="text-lg border-[1px] border-black rounded-full py-2 px-3 inline-block w-[40%] text-center">
                Shop Cards
              </div>
            </div>
            <img
