...
function MenClothing() {
  ...
  return (
    <div>
      ...
      <div className='flex justify-evenly items-center bg-gray-200 w-[90%] mx-auto rounded-lg mt-3 py-5'>
        <div className='w-[90%] flex justify-center items-center bg-white gap-20 py-3'>
          <div className='w-[35%] py-5 px-10 flex flex-col gap-4'>
            <p className='text-[35px] font-bold leading-tight'>Welcome to the world of Fashion!</p>
            <p className='text-[18px] font-semibold'>Browse all the clothes you need, from design to brands.</p>
          </div>
          <div>
            <img src="https://www.shutterstock.com/image-photo/set-stylish-clothes-on-white-260nw-1804224286.jpg" alt="fashion" className='w-[100%] h-64 flex items-center justify-center' />
          </div>
        </div>
      </div>
